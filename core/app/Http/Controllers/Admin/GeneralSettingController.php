...
class GeneralSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'timezone' => 'required',
            'fixedcharge' => 'required|numeric|gt:0',
            'featured_price' => 'required|numeric|gt:0',
            'percentagecharge' => 'required|numeric|gt:0',
            'searchmax' => 'required|numeric|gt:0',
        ]);
        $general = GeneralSetting::first();
        ...
        $general->charge_status = $request->charge_status ? 1 : 2;
        ...
        $general->fixed_charge = $request->fixedcharge;
        $general->percentage_charge = $request->percentagecharge;
        $general->coin_rate_api = $request->coin_rate_api;
        $general->search_max = $request->searchmax;
        $general->featured_price = $request->featured_price;
        $general->save();
