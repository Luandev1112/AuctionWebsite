    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.brand.index')}}">
                    <a href="{{route('admin.brand.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.brand.index') }}">
                        <i class="menu-icon las la-ring"></i>
                        <span class="menu-title">@lang('Manage Brand')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.specification.index')}}">
                    <a href="{{route('admin.specification.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.specification.index') }}">
                        <i class="menu-icon las la-spinner"></i>
                        <span class="menu-title">@lang('Manage Specification')</span>
                    </a>
                </li>
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.product*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.product.expired')}} ">
                             ...
                             <li class="sidebar-menu-item {{menuActive('admin.product.report')}} ">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.order*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.order.complated')}} ">
                                <a href="{{route('admin.order.complated')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Complated')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.order.inProcess')}} ">
                                <a href="{{route('admin.order.inProcess')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('In Process')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.order.shipped')}} ">
                                <a href="{{route('admin.order.shipped')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Shipped')</span>
                                </a>
                            </li>

                             <li class="sidebar-menu-item {{menuActive('admin.order.disputed')}} ">
                                <a href="{{route('admin.order.disputed')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.ads*')}}">
                    <a href="{{route('admin.ads.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.ads.index') }}">
                        ...
                        <span class="menu-title">@lang('All Advertisement')</span>
                    </a>
                </li>
