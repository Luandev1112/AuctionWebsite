                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('BTC Rate Api Key') </label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Charge Status')</label>
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disabled')" name="charge_status" @if($general->charge_status==1) checked @endif>
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold"> @lang('Fixed Charge') </label>
                                    <div class="input-group mb-3">
                                        <input type="text" id="value" class="form-control form-control-lg" name="fixedcharge" value="{{getAmount($general->fixed_charge)}}" required="">
                            ...
                            <div class="col-md-3">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Percentage Charge')</label>
                                    <div class="input-group mb-3">
                                        <input type="text" id="value" class="form-control form-control-lg" name="percentagecharge" value="{{getAmount($general->percentage_charge)}}" required="">
                                        <div class="input-group-append">
                        ...
                        <div class="row">
                             <div class="col-md-2">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Featured Price')</label>
                                    <div class="input-group mb-3">
                                        <input type="text" id="value" class="form-control form-control-lg" name="featured_price" value="{{getAmount($general->featured_price)}}" required="">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">{{$general->cur_text}}</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Search Max')</label>
                                    <div class="input-group mb-3">
                                        <input type="text" id="value" class="form-control form-control-lg" name="searchmax" value="{{getAmount($general->search_max)}}" required="">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">{{$general->cur_text}}</span>
                                        </div>
                                    </div>
