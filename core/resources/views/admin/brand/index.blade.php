...
@section('panel')
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            @forelse($brands as $brand)
                                <tr>
                                    <td data-label="@lang('Name')">{{__($brand->name)}}</td>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="javascript:void(0)" class="icon-btn btn--primary ml-1 updateBrand"
                                            data-id="{{$brand->id}}"
    ...
    <div id="brandModel" class="modal fade" tabindex="-1" role="dialog">
    ...
    <div id="updateBrandModel" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
@push('breadcrumb-plugins')
    <a href="javascript:void(0)" class="btn btn-sm btn--primary box--shadow1 text--small addBrand" ><i class="fa fa-fw fa-paper-plane"></i>@lang('Add Brand')</a>
@endpush
