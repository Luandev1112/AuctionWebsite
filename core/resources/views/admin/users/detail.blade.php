            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--3 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.product.list', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$product['totalProduct']}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Product')</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--info b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.sold.product.list', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$product['soldProduct']}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Sold Product')</span>
                            </div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--19 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.purchase.product.list', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$product['purchase']}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Purchase')</span>
                            </div>
                        </div>
                    </div>
                </div>
