                ...
                <div class="col-lg-6 left-side">
                    ...
                    <form class="account-form" method="POST" action="{{route('user.verify.sms')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="code" maxlength="7" class="form-control form--control" name="sms_verified_code" required="">
                        </div>
                ...
                <div class="col-lg-6 right-side d-flex flex-wrap align-items-center">
                    <div class="w-100">
                        <div class="account-header text-center mb-3">
                            ...
                            <h5 class="title mt-3">@lang('Your Email'): <strong>{{auth()->user()->mobile}}</strong></h5>
                        </div>
